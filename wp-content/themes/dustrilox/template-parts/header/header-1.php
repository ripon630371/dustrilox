<?php 
	...
	*/
    ...
    $dustrilox_phone_num = get_theme_mod( 'dustrilox_phone_num', __( '01303326123', 'dustrilox' ) );
                  ...
                  <div class="header-info f-right">
                        ...
                        <?php if(!empty($dustrilox_mail_id)): ?>
                           <div class="info-item">
                              ...
                              <h5><a href="mailto:<?php echo esc_url($dustrilox_mail_id); ?>"><?php echo esc_html($dustrilox_mail_id); ?></a></h5>
                           </div>
                        <?php endif; ?>  
                  </div>
               </div>
